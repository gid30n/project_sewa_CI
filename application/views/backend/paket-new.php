										...
										<div class="input-field">
											...
											<div class="col m9 s12">
												<select name="kategori" id="kategori">
											      ...
											      <option value="1">Paket Pesta</option>
											      <option value="2">Perlengkapan Pesta</option>											      
											    </select>											    
											</div>								
										</div>
									</div>
										...
										<div class="input-field">
											...
											<div class="col m9 s12">
												<select name="s_kategori" id="s_kategori">
											      ...
											      <option value="1">Paket Pernikahan</option>
											      <option value="2">Paket Acara Adat Bali</option>
											      <option value="3">Paket Catering</option>
											      <option value="4">Paket Ulang Tahun</option>
											      <option value="5">Paket Dekorasi</option>											      
											    </select>											    
											</div>								
										</div>
									</div>
									<div class="row" id="sub_kategori_perlengkapan">
										<div class="input-field">
											<div class="col m3 s12">
												<label for="s_kategori" class="teal-text col m3">Sub Kategori <sup class="red-text">*</sup></label>
												<br class="hide-on-med-and-up">
											...
											<div class="col m9 s12">
												<select name="s_kategori" id="s_kategori">
											      ...
											      <option value="4">Sound System</option>
											      <option value="5">Panggung/Podioum/Mimbar</option>
											      <option value="6">Lighting</option>
											      <option value="7">Standing AC</option>
											      <option value="8">Alat Music</option>
											      <option value="9">Riging</option>											      
											      <option value="10">Alat Catering</option>
											      <option value="11">Genset</option>
											      <option value="12">Flooring</option>
											      <option value="13">TV/Screen + Infocus</option>
											      <option value="14">Mobil Pengantin</option>											      
											    </select>											    
											</div>								
										</div>
									</div>
