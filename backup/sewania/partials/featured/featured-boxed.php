<?php 
/**
 * The template for displaying featured post in slider boxed type.
 *
 * @package Writsy
 * @since   1.0
 */
...
<div class="featured-area">
    <div class="container">
        <div class="featured-boxed">
            <div id="featured-slider-images" class="featured-slider featured-slider-images">
            ...
            <div id="featured-slider-content" class="featured-slider featured-slider-content">
                <?php foreach ($featured_posts as $post) : setup_postdata($post); ?>
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <div class="entry-content">
                            <?php echo writsy_excerpt(20, true); ?>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
